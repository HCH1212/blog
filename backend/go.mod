module github.com/HCH1212/blog/backend

go 1.23.4

require (
	github.com/HCH1212/utils v0.0.0-20250214090614-3b9f902e84cb
	github.com/cloudwego/eino v0.3.17
	github.com/cloudwego/eino-ext/components/model/ollama v0.0.0-20250320062631-616205c32186
